...
class dispatcher {
    ...
    private function body():string {
        $html = '';
        $html .= '<body>';
        $html .= '<h1>ispencil2</h1>';
        $html .= '<form action="index.php" method="POST" enctype="" name="ispencil2">';
    ...
    private static function ispclRenderingScript(array $params):string {
        ...
        $html .= 'import {attachIsPencil} from "./ispenengine.js";';
